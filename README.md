...
2. Navigate to the folder that contains `app.py`.
3. Run the app:
...
5. Click Login or Register from the home page.
6. After login, open the Prediction page, upload an image, and click Submit to view the result.
